...
function LeftColumn() {
  return (
    <div className="w-[50%] z-10  text-white p-4 mt-24">
      <HighlightDiv />
    </div>
  );
}
...
function RightColumn() {
  return (
    <div id="about" className="about-section z-10 w-[50%] h-screen overflow-y-auto hide-scrollbar ">
...
function App() {
  return (
    <div className="flex h-screen gap-x-4 px-32  overflow-hidden">
      <GridBackgroundDemo />
      <LeftColumn />
      <RightColumn />
    </div>
